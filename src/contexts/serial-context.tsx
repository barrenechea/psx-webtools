...
export const SerialProvider: React.FC<{ children: React.JSX.Element }> = ({
  ...
  const connectToPort = async (options: SerialOptions): Promise<void> => {
    try {
      ...
      throw new Error(`Error connecting to port: ${(error as Error).message}`);
    }
  };
